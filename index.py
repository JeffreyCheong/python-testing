...
CONNECTION_STR = 'Endpoint=sb://hussmanntsilab.servicebus.windows.net/;SharedAccessKeyName=testsource;SharedAccessKey=Bzl0qVPhBRxhgtKDDp+hjSnfy6bzU5evRTtOJNeZFMQ=;EntityPath=localtest'
EVENTHUB_NAME = 'localtest' 
